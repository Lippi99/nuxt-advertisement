...
import { u as useHead, i as useRoute, e as useToast, f as _sfc_main$7 } from './server.mjs';
import { defineComponent, ref, withAsyncContext, reactive, mergeProps, withCtx, unref, createVNode, createTextVNode, renderSlot, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch(`/api/playlists/${id}`, {
      method: "GET"
    }, "$yuhAUBf-3P")), __temp = await __temp, __restore(), __temp);
    const state = reactive({
      name: ((_a = data.value) == null ? void 0 : _a.playlist.name) || void 0
    });
    ...
    async function onSubmit(event) {
      ...
      try {
        ...
        toast.add({
          title: "Erro",
          description: "Houve um erro na atualiza\xE7\xE3o da playlist",
          color: "error"
        });
      } finally {
...
//# sourceMappingURL=_id_-CKR0GWcC.mjs.map
