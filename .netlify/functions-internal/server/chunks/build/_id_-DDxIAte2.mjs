...
import { defineComponent, computed, withAsyncContext, ref, reactive, mergeProps, withCtx, unref, createVNode, createTextVNode, renderSlot, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch(`/api/estabelecimentos/${id.value}`, {
      method: "GET"
    }, "$g3ER1DExi8")), __temp = await __temp, __restore(), __temp);
    const title = ref(((_b = (_a = data.value) == null ? void 0 : _a.estabelecimento) == null ? void 0 : _b.name) || "");
    useHead({
      title: `${title.value} | Nuxt advertisement`
    });
    const state = reactive({
      name: ((_d = (_c = data.value) == null ? void 0 : _c.estabelecimento) == null ? void 0 : _d.name) || void 0
    });
    ...
    async function onSubmit(event) {
      ...
      try {
        ...
        toast.add({
          title: "Erro",
          description: "Houve um erro na atualiza\xE7\xE3o do estabelecimento",
          color: "error"
        });
      } finally {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/estabelecimentos/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_id_-DDxIAte2.mjs.map
