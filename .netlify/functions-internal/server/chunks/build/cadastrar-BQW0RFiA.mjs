...
import { defineComponent, reactive, ref, mergeProps, withCtx, unref, createVNode, createTextVNode, renderSlot, useSSRContext } from 'vue';
  ...
  setup(__props) {
    ...
    async function onSubmit(event) {
      ...
      try {
        ...
        toast.add({
          title: "Erro",
          description: "Houve um erro na cria\xE7\xE3o do estabelecimento",
          color: "error"
        });
      } finally {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/estabelecimentos/cadastrar.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=cadastrar-BQW0RFiA.mjs.map
