import { u as useHead, f as useToast, h as _sfc_main$7 } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data, status, refresh } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/usuarios", {
      method: "GET"
    }, "$TEFtXDjpVt")), __temp = await __temp, __restore(), __temp);
    const columns = [
      {
        accessorKey: "id",
        header: "Id"
    ...
    const deleteTitle = computed(
      () => `Tem certeza que deseja excluir o usu\xE1rio ${selectedUser.value}?`
    );
    const handleDeleteUser = async () => {
      var _a;
      const id = (_a = selectedUser.value) == null ? void 0 : _a.id;
      try {
        ...
        toast.add({
          title: "Erro",
          description: "Houve um erro ao excluir o usu\xE1rio",
          color: "error"
        });
      }
    };
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_UTable, {
              ...
              data: (_a = unref(data)) == null ? void 0 : _a.usuarios,
              columns,
              "pagination-options": {
            ...
            _push2(ssrRenderComponent(_component_UModal, {
              ...
              content: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a2, _b2;
                if (_push3) {
                  _push3(`<div class="p-4 space-y-4"${_scopeId2}><h2 class="text-lg font-semibold"${_scopeId2}>Confirmar exclus\xE3o</h2><p${_scopeId2}> Tem certeza que deseja excluir <strong${_scopeId2}>${ssrInterpolate((_a2 = unref(selectedUser)) == null ? void 0 : _a2.name)}</strong>? </p><div class="flex justify-between gap-2 mt-12"${_scopeId2}>`);
                  ...
                  return [
                    createVNode("div", { class: "p-4 space-y-4" }, [
                      ...
                      createVNode("p", null, [
                        ...
                        createVNode("strong", null, toDisplayString((_b2 = unref(selectedUser)) == null ? void 0 : _b2.name), 1),
                        createTextVNode("? ")
                      ]),
            ...
            return [
              ...
              createVNode("div", { class: "w-full space-y-4 pb-4 mt-12" }, [
                createVNode(_component_UTable, {
                  ...
                  pagination: unref(pagination),
                  "onUpdate:pagination": ($event) => isRef(pagination) ? pagination.value = $event : null,
                  data: (_h = unref(data)) == null ? void 0 : _h.usuarios,
                  columns,
                  "pagination-options": {
                    getPaginationRowModel: unref(getPaginationRowModel)()
                  },
                ...
                content: withCtx(() => {
                  ...
                  return [
                    createVNode("div", { class: "p-4 space-y-4" }, [
                      ...
                      createVNode("p", null, [
                        createTextVNode(" Tem certeza que deseja excluir "),
                        createVNode("strong", null, toDisplayString((_a2 = unref(selectedUser)) == null ? void 0 : _a2.name), 1),
                        createTextVNode("? ")
                      ]),
                      createVNode("div", { class: "flex justify-between gap-2 mt-12" }, [
                        createVNode(unref(UButton), {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/usuarios/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-CthDniUe.mjs.map
