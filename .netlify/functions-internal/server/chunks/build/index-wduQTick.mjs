...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data, status, refresh } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/playlists", {
      method: "GET"
    }, "$jkt6BFtaOw")), __temp = await __temp, __restore(), __temp);
    const columns = [
      {
        accessorKey: "id",
        header: "Id"
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_UTable, {
              ...
              data: (_a = unref(data)) == null ? void 0 : _a.playlists,
              columns,
              "pagination-options": {
            ...
            return [
              ...
              createVNode("div", { class: "w-full space-y-4 pb-4 mt-12" }, [
                createVNode(_component_UTable, {
                  ...
                  pagination: unref(pagination),
                  "onUpdate:pagination": ($event) => isRef(pagination) ? pagination.value = $event : null,
                  data: (_h = unref(data)) == null ? void 0 : _h.playlists,
                  columns,
                  "pagination-options": {
                    getPaginationRowModel: unref(getPaginationRowModel)()
                  },
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/playlists/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-wduQTick.mjs.map
