...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CqV41SmY.mjs')
  },
  {
    name: "login",
    path: "/login",
...
function useAsyncData(...args) {
  ...
  const asyncData = (_a2 = nuxtApp._asyncData)[_b = key.value] ?? (_a2[_b] = createAsyncData(nuxtApp, key.value, _handler, options, initialCachedData));
  asyncData._deps++;
...
const ipxRuntime$Xw4iclrtk5DS6ung3PC8a5jt57ff4iDpq3Bj8Pyef5o = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
imageOptions.providers = {
  ["ipx"]: { provider: ipxRuntime$Xw4iclrtk5DS6ung3PC8a5jt57ff4iDpq3Bj8Pyef5o, defaults: {} }
};
const useImage = () => {
  const config = /* @__PURE__ */ useRuntimeConfig();
  const nuxtApp = useNuxtApp();
      ...
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            return [
              __props.src && !error.value ? (openBlock(), createBlock(resolveDynamicComponent(unref(_sfc_main$b)), mergeProps({
                key: 0,
                role: "img",
                src: __props.src,
                alt: __props.alt,
