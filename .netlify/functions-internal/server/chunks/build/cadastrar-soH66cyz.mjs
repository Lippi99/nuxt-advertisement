...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const schema = z.object({
      ...
      password: z.string({ message: "Campo obrigat\xF3rio" }).min(8, { message: "M\xEDnimo de 8 caract\xE9res" }),
      passwordRepeat: z.string({ message: "Campo obrigat\xF3rio" }).min(8, { message: "M\xEDnimo de 8 caract\xE9res" }),
      roleId: z.number().int()
    ...
    const { data: roles } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/roles", "$GfP1pwgUuW")), __temp = await __temp, __restore(), __temp);
    async function onSubmit(event) {
      ...
      try {
        ...
        state.name = void 0;
        state.lastName = void 0;
        state.email = void 0;
        state.birth = void 0;
        state.password = void 0;
        state.passwordRepeat = void 0;
      } catch {
        toast.add({
          title: "Erro",
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_USelect, {
                                ...
                                items: (_a = unref(roles)) == null ? void 0 : _a.roles,
                                "value-key": "id",
                                "label-key": "name",
                                class: "w-full"
                              }, null, _parent5, _scopeId4));
                              ...
                              return [
                                createVNode(_component_USelect, {
                                  modelValue: unref(state).roleId,
                                  "onUpdate:modelValue": ($event) => unref(state).roleId = $event,
                                  items: (_b = unref(roles)) == null ? void 0 : _b.roles,
                                  "value-key": "id",
                                  "label-key": "name",
                                  class: "w-full"
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/usuarios/cadastrar.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=cadastrar-soH66cyz.mjs.map
