import { computed, useId, inject, provide, ref, readonly, createVNode, resolveDynamicComponent, unref, mergeProps, withCtx, renderSlot, useSlots, createTextVNode, toDisplayString, createBlock, createCommentVNode, openBlock, mergeModels, useModel, useSSRContext } from 'vue';
...
import { a as useAppConfig, t as tv, x as formBusInjectionKey, y as formInputsInjectionKey, z as formLoadingInjectionKey, A as formOptionsInjectionKey, B as inputIdInjectionKey, C as formFieldInjectionKey, m as useFormField, n as useButtonGroup, o as useComponentIcons, b as _sfc_main$c, c as _sfc_main$a, D as looseToNumber } from './server.mjs';
...
const _sfc_main$2 = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const ui = computed(() => {
      var _a2;
      return tv({ extend: tv(theme$2), ...((_a2 = appConfig.ui) == null ? void 0 : _a2.form) || {} });
    });
          ...
          if (_push2) {
            ...
            return [
              ...
              createVNode("div", {
                ...
                ], 10, ["id"])) : __props.help || !!slots.help ? (openBlock(), createBlock("p", {
                  key: 1,
            ...
            return [
              ...
              unref(isTrailing) || !!slots.trailing ? (openBlock(), createBlock("span", {
                ...
                renderSlot(_ctx.$slots, "trailing", {}, () => {
                  var _a3;
                  return [
                    unref(trailingIconName) ? (openBlock(), createBlock(_sfc_main$c, {
                      key: 0,
                      name: unref(trailingIconName),
                      class: ui.value.trailingIcon({ class: (_a3 = props.ui) == null ? void 0 : _a3.trailingIcon })
...
//# sourceMappingURL=Input-K2S8Vn62.mjs.map
