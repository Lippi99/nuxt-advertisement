...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const state = reactive({
      name: void 0,
      establishmentId: void 0,
      playlistId: void 0
    });
    const isSubmitting = ref(false);
    const toast = useToast();
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/estabelecimentos", {
      method: "GET"
    }, "$HWrRrBwsCq")), __temp = await __temp, __restore(), __temp);
    const { data: playlists } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/playlists", {
      method: "GET"
    }, "$IcxrIv4Xg8")), __temp = await __temp, __restore(), __temp);
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_USelect, {
                                ...
                                items: (_a = unref(data)) == null ? void 0 : _a.estabelecimentos,
                                "label-key": "name",
                                "value-key": "id",
                                ui: {
                              ...
                              return [
                                createVNode(_component_USelect, {
                                  ...
                                  modelValue: unref(state).establishmentId,
                                  "onUpdate:modelValue": ($event) => unref(state).establishmentId = $event,
                                  items: (_b = unref(data)) == null ? void 0 : _b.estabelecimentos,
                                  "label-key": "name",
                                  "value-key": "id",
                                  ui: {
                                    trailingIcon: "group-data-[state=open]:rotate-180 transition-transform duration-200"
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_USelect, {
                                ...
                                items: (_a = unref(playlists)) == null ? void 0 : _a.playlists,
                                "label-key": "name",
                                "value-key": "id",
                                ui: {
                                  trailingIcon: "group-data-[state=open]:rotate-180 transition-transform duration-200"
                              ...
                              return [
                                createVNode(_component_USelect, {
                                  ...
                                  modelValue: unref(state).playlistId,
                                  "onUpdate:modelValue": ($event) => unref(state).playlistId = $event,
                                  items: (_b = unref(playlists)) == null ? void 0 : _b.playlists,
                                  "label-key": "name",
                                  "value-key": "id",
                                  ui: {
                                    trailingIcon: "group-data-[state=open]:rotate-180 transition-transform duration-200"
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/monitores/cadastrar.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=cadastrar-CJNPVJs-.mjs.map
